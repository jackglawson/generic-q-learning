...
def func(x, mu1, sigma1, mu2, sigma2):
    p_1 = get_normal_dist_pdf(mu1, sigma1, x)
    f_2 = get_normal_dist_cdf(mu2, sigma2, x)
    return p_1 * (1 - f_2)
...
def get_prob_q2_greater_than_q1(mu1, sigma1, mu2, sigma2):
    ...
    result, error = quad(func, -np.inf, np.inf, args=(mu1, sigma1, mu2, sigma2))[0:2]
